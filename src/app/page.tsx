  ...
  return (
    <div>
      ...
      <section className="relative overflow-hidden bg-[#1A1A1A] py-20 md:py-32">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-8 grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          {/* 左: テキスト */}
          <div>
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-4xl xl:text-5xl font-extrabold text-white leading-[1.1] tracking-tighter mb-6 sm:mb-8">
              <span className="block lg:whitespace-nowrap">JKKの空き家が出た瞬間、</span>
              <span className="block lg:whitespace-nowrap">あなたのLINEに届く。</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
              <a
                ...
                className="bg-[#06C755] text-white px-8 py-4 sm:px-10 sm:py-5 rounded-lg text-base sm:text-lg font-bold flex items-center justify-center gap-3 transition-all duration-200 hover:opacity-90 active:scale-95 shadow-lg shadow-black/30"
              >
          ...
          <div className="flex items-center justify-center mt-4 lg:mt-0">
            <div className="bg-white/95 backdrop-blur-sm rounded-lg shadow-[0_24px_60px_rgba(0,0,0,0.3)] px-8 py-8 sm:p-12 text-center w-full max-w-sm">
              <p className="text-[#6C757D] text-sm mb-4 sm:mb-6 uppercase tracking-widest">現在の空き家</p>
              <div className="mb-6 sm:mb-8">
                <span className="text-7xl sm:text-8xl font-extrabold text-[#1A1A1A] tracking-tighter leading-none">
                  {propertyCount}
                </span>
                <span className="text-xl sm:text-2xl font-bold text-[#6C757D] ml-2">物件</span>
              </div>
              <div className="h-px bg-[#E9ECEF] mb-6 sm:mb-8" />
              <div>
                <span className="text-4xl sm:text-5xl font-extrabold text-[#1A1A1A] tracking-tighter leading-none">
                  {unitCount}
                </span>
                <span className="text-lg sm:text-xl font-bold text-[#6C757D] ml-2">戸</span>
              </div>
              <p className="text-[#6C757D] text-xs mt-4 sm:mt-6">リアルタイム更新中</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            <div>
              ...
              <h2
                className="text-3xl sm:text-4xl font-extrabold text-[#1A1A1A] tracking-tight mb-6"
                style={{ fontFamily: "Manrope, sans-serif" }}
              >
                気になる区だけ、<br />通知を受け取る。
              </h2>
              <p className="text-[#6C757D] leading-relaxed mb-8 sm:mb-10">
              ...
              <div className="flex flex-col gap-4 mb-8 sm:mb-10">
                {[
                  ...
                  <div key={step} className="flex items-center gap-4">
                    ...
                    <span className="text-[#1A1A1A] font-medium text-sm sm:text-base">{text}</span>
                  </div>
                ))}
              </div>
              <a
            ...
            {/* 右: 対応区一覧 */}
            <div className="bg-[#F8F9FA] rounded-lg border border-[#1A1A1A]/5 p-6 sm:p-8">
        ...
        <section className="py-16 sm:py-24 bg-[#F3F4F5]">
          <div className="max-w-7xl mx-auto px-4 sm:px-8">
            <div className="flex justify-between items-end mb-8 sm:mb-12">
              <h2
                className="text-3xl sm:text-4xl font-extrabold text-[#1A1A1A] tracking-tight"
                style={{ fontFamily: "Manrope, sans-serif" }}
              >
                JKK攻略ガイド
              </h2>
              <Link
                href="/guide"
                className="text-sm font-semibold text-[#1A1A1A] flex items-center gap-1 hover:opacity-60 transition-opacity whitespace-nowrap"
              >
                すべて見る
                <ArrowRight size={16} />
              </Link>
      ...
      {/* 物件一覧セクション */}
      <section id="vacancy-list" className="py-16 sm:py-24 bg-[#F8F9FA]">
        <div className="max-w-7xl mx-auto px-4 sm:px-8">
